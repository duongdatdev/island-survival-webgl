...
export class BiomeGenerator {
    ...
    constructor(prng: PRNG, island: IslandGenerator) {
        this.prng = prng;
        this.island = island;
     ...
     */
    public getBiome(x: number, z: number, height: number): BiomeType {
    ...
    private mix(start: number, end: number, amt: number): number {
